...
import (
	...
	_ "github.com/marvel/docs" // docs is generated by Swag CLI, you have to import it.
...
func routing() {
	...
	routes.HandleFunc("/characters", getAllCharacters)
	routes.HandleFunc("/characters/{id}", getCharacterById)
	// Swagger
...
func init() {
	...
	if *strategy == "PREFETCH" {
		...
		c.AddFunc("@every 15m", invalidateAndRefresh)
		c.Start()
	}
}
